{{-- halaman untuk mengatur edit profile
    termasuk mengganti password dan foto
    --}}
...
<form action="/presensi/{{ $karyawan->nik}}/updateprofile" method="POST" enctype="multipart/form-data" >
    ...
    <div class="col">
        ...
        <div class="form-group boxed">
            <div class="input-wrapper">
                <input type="text" class="form-control" value="{{ $karyawan->jabatan}}" name="jabatan" placeholder="Nama Lengkap" autocomplete="off">
            </div>
        </div>
        <div class="form-group boxed">
            <div class="input-wrapper">
        ...
        <div class="form-group boxed">
            <div class="input-wrapper">
                <input type="text" class="form-control" value="{{ $karyawan->alamat}}" name="alamat" placeholder="Alamat" autocomplete="off">
            </div>
        </div>
        <div class="form-group boxed">
            <div class="input-wrapper">
        ...
        <div class="form-group boxed">
            <div class="input-wrapper">
                <button type="submit" class="btn  btn-block" style="background: #0f2e64; color:white">
