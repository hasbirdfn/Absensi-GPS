<form action="/status/{{$status->kode_status}}/update" method="POST" id="frmStatus">
    @csrf
    <div class="row">
      <div class="col-12">
        <div class="input-icon mb-3">
          ...
          <input type="text" value="{{$status->kode_status}}" id="kode_status"  class="form-control" placeholder="Ketik Kode Status Anda" name="kode_status" readonly>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
        <div class="input-icon mb-3">
          ...
          <input type="text" id="nama_status" name="nama_status" value="{{$status->nama_status}}" class="form-control" placeholder="Ketik Nama Status Anda">
        </div>
      </div>
    </div>
    <div class="row mt-2">
